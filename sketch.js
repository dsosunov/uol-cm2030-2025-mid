...
class Table {
  ...
  drawD() {
    ...
    strokeWeight(2);
    translate(this.position.x, this.position.y);
    arc(-this.position.x / 3, 0, 250, 250, 90, 270);
    pop();
  }
  drawBalls() {
  ...
  spawnBorders() {
    ...
    borders.push(
      new TableBorder(
        this.position,
        createVector(-this.size.x / 4, -this.size.y / 2 - borderThickness / 2),
        createVector(borderLength, borderThickness),
        "#41230d"
      )
    );
    // Top-right border
    ...
    borders.push(
      new TableBorder(
        this.position,
        createVector(this.size.x / 2 + borderThickness / 2, 0),
        createVector(borderThickness, borderLength),
        "#41230d"
      )
    );
    // Bottom-right border
  ...
  spawnPocketCovers() {
    ...
    pocketCovers.push(
      new PocketCover(
        this.position,
        createVector(0, -this.size.y / 2 - pocketCoverThickness / 2),
        createVector(this.pocketCoverWidth, pocketCoverThickness),
        "#ecd850"
      )
    );
    ...
    pocketCovers.push(
      new PocketCover(
        ...
        createVector(
          this.size.x / 2,
          -this.size.y / 2 - pocketCoverThickness / 2
        ),
        createVector(this.pocketCoverWidth, pocketCoverThickness),
        "#ecd850"
      )
    ...
    pocketCovers.push(
      new PocketCover(
        ...
        createVector(
          this.size.x / 2 +
            this.pocketCoverWidth / 2 -
            pocketCoverThickness / 2,
          -this.size.y / 2
        ),
        createVector(pocketCoverThickness, this.pocketCoverWidth),
        "#ecd850"
      )
    );
  ...
  spawnCushions() {
    ...
    cushions.push(
      new Cushion(
        createVector(
          ...
          this.position.y - this.size.y / 2 + offsetFromBorder
        ),
        [
          {
            x: -cushionLength + this.pocketDiameter / 7,
            y: this.pocketDiameter,
          },
          {
            x: -cushionLength + (this.pocketDiameter * 5) / 7,
            y: this.pocketDiameter * 1.5,
          },
          {
            x: cushionLength - this.pocketDiameter / 7,
            y: this.pocketDiameter,
    ...
    cushions.push(
      new Cushion(
        createVector(
          this.position.x + this.size.x / 2 - offsetFromBorder,
          this.position.y
        ),
        [
          {
            x: this.pocketDiameter,
            y: -cushionLength - this.pocketDiameter / 7,
          },
          {
            x: this.pocketDiameter * 1.5,
            y: -cushionLength - (this.pocketDiameter * 5) / 7,
          },
          {
            x: this.pocketDiameter,
            y: cushionLength + this.pocketDiameter / 7,
  ...
  spawnBalls() {
    ...
    balls.push(
      new CueBall(
        this.position,
        createVector(-this.size.x / 4 - this.ballDiameter * 2, 0),
        this.ballDiameter
      )
    );
    // Green
    balls.push(
      new Ball(
        this.position,
        createVector(-this.size.x / 3 + 125 + this.ballDiameter / 4, -125),
        this.ballDiameter,
        "green"
      )
    );
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(-this.size.x / 3 + 125 + this.ballDiameter / 4, 0),
        this.ballDiameter,
        "brown"
      )
    );
    ...
    // Blue
    balls.push(
      new Ball(this.position, createVector(0, 0), this.ballDiameter, "blue")
    );
    // Pink
    balls.push(
      new Ball(
        this.position,
        createVector(this.size.x / 6 - this.ballDiameter * 1, 0),
        this.ballDiameter,
        "pink"
      )
    );
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(this.size.x / 2.5 - this.ballDiameter * 1, 0),
        this.ballDiameter,
        "black"
      )
    );
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(this.size.x / 6 + this.ballDiameter * 0, 0),
        this.ballDiameter,
        "red"
      )
    );
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(
          this.size.x / 6 + this.ballDiameter * 1,
          -this.ballDiameter / 2
        ),
        this.ballDiameter,
        "red"
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(
          this.size.x / 6 + this.ballDiameter * 2,
          -this.ballDiameter
        ),
        this.ballDiameter,
        "red"
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(this.size.x / 6 + this.ballDiameter * 2, 0),
        this.ballDiameter,
        "red"
      )
    );
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(
          this.size.x / 6 + this.ballDiameter * 3,
          (-this.ballDiameter * 3) / 2
        ),
        this.ballDiameter,
        "red"
      )
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(
          this.size.x / 6 + this.ballDiameter * 4,
          -this.ballDiameter * 2
        ),
        this.ballDiameter,
        "red"
    ...
    balls.push(
      new Ball(
        this.position,
        createVector(this.size.x / 6 + this.ballDiameter * 4, 0),
        this.ballDiameter,
        "red"
      )
    );
...
class Ball {
  ...
  turnPhysicsOn() {
    this.body = Bodies.circle(
      this.tablePosition.x + this.position.x,
      this.tablePosition.y + this.position.y,
      this.diameter / 2,
      this.physicsOptions
    );
    Composite.add(engine.world, [this.body]);
